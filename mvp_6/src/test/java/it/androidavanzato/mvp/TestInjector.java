...
public class TestInjector {
    ...
    private Map<Integer, InvocableMethod> onClickMethods;

    private Map<Integer, InvocableMethod> onItemClickMethods;

    public void inject(Object object) {
        try {
            initFields(object);
            onClickMethods = initOnClickListeners(object);
            onItemClickMethods = initOnItemClickListeners(object);
        } catch (Exception e) {
    ...
    private Map<Integer, InvocableMethod> initOnClickListeners(Object object) throws Exception {
        Map<Integer, InvocableMethod> onClickMethods = new HashMap<>();
        CtClass objectClass = ClassPool.getDefault().get(object.getClass().getName());
    ...
    private Map<Integer, InvocableMethod> initOnItemClickListeners(Object object) throws Exception {
        Map<Integer, InvocableMethod> onItemClickMethods = new HashMap<>();
        CtClass objectClass = ClassPool.getDefault().get(object.getClass().getName());
        CtMethod[] declaredMethods = objectClass.getDeclaredMethods();
        for (CtMethod method : declaredMethods) {
    ...
    public static <T> T createFake(Class<T> fakeClass) {
        try {
            ...
            MethodHandler methodHandler = new MethodHandler() {
                ...
                @Override
                public Object invoke(Object self, Method overridden, Method proceed, Object[] args) {
